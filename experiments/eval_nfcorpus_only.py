#!/usr/bin/env python3
"""Run NFCorpus evaluation only (SciFact already completed)."""
...
from fluke.evaluation.benchmarks import compute_metrics
...
def load_beir_local(dataset_name, split="test"):
    from beir.datasets.data_loader import GenericDataLoader

    data_path = f"/tmp/beir_data/{dataset_name}"
